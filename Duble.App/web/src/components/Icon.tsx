// components/Icon.tsx — the icon set: 24×24, 1.8 stroke, rounded caps.
//
// The shapes are JSX rather than strings of markup, so the compiler checks them and React can diff them.
import type { ReactNode } from 'react';

const shapes = {
  logo: (
    <>
      <rect x="3" y="3" width="12" height="12" rx="3.2" fill="currentColor" opacity=".55" stroke="none" />
      <rect x="8.5" y="8.5" width="12" height="12" rx="3.2" fill="currentColor" stroke="none" />
      <path d="M12.6 12h2.6a2.6 2.6 0 0 1 0 5.2h-2.6z" fill="var(--bg,#1B1A1F)" stroke="none" />
    </>
  ),
  ...
  gamepad: (
    <>
      <path d="M6 8h12a4 4 0 0 1 4 4v3.5a2.5 2.5 0 0 1-4.6 1.4L16 15H8l-1.4 1.9A2.5 2.5 0 0 1 2 15.5V12a4 4 0 0 1 4-4z" />
  ...
  toggleOn: (
    <>
      <rect x="2" y="7" width="20" height="10" rx="5" fill="currentColor" stroke="none" />
      <circle cx="17" cy="12" r="3.5" fill="var(--panel,#fff)" stroke="none" />
    </>
  ),
  toggleOff: (
    <>
  ...
  palette: (
    <>
      <path d="M12 3.5a8.5 8.5 0 1 0 0 17c1.4 0 2.1-.8 2.1-1.8 0-.9-.6-1.2-.6-2 0-.9.7-1.6 1.6-1.6h1.8a3.6 3.6 0 0 0 3.6-3.6C20.5 7 16.7 3.5 12 3.5z" />
      ...
      <circle cx="16.9" cy="11.2" r="1.1" fill="currentColor" stroke="none" />
    </>
  ),
