...
| [Vite](https://vite.dev) and [TypeScript](https://www.typescriptlang.org) | MIT / Apache-2.0 | Build the interface; neither ships in the executable |
...
CodeWalker.Core is a git submodule under `external/CodeWalker`; the C# components arrive as NuGet packages and
the interface's as npm packages, listed in `Duble.App/web/package.json`.
