...
public class ArgumentyTests
{
    ...
    public void Parsuje_wszystkie_przelaczniki()
    {
        ...
        Assert.True(a.Dev); Assert.Equal(@"C:\ui", a.UiFolder); Assert.Equal(@"C:\p\Studio.duble", a.Projekt);
    ...
    public void Bez_argumentow_wszystko_puste()
    {
        ...
        Assert.False(a.Dev); Assert.Null(a.UiFolder); Assert.Null(a.Projekt); Assert.Null(a.Widok); Assert.Null(a.Zrzut);
    }
    ...
    public void Plik_duble_bez_przelacznika_to_projekt()
    {
        ...
        Assert.Equal(@"C:\p\Moj.duble", a.Projekt);
    }
}
